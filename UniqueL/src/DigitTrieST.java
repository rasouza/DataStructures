...
/******************************************************************************
 *  Compilation:  javac DigitTrieST.java
 *  Execution:    java DigitTrieST < words.txt
 *  Dependencies: StdIn.java
 *
 *  A string symbol table for extended ASCII strings, implemented
 *  using a 256-way trie.
 *
 *  % java DigitTrieST < shellsST.txt 
 *  by 4
 *  sea 6
 *  sells 1
 *  she 0
...
/**
 *  The <tt>DigitTrieST</tt> class represents an symbol table of key-value
 ...
 */
public class DigitTrieST<Value> implements ITabelaSimbolo<String, Value> {
   ...
   /**
    ...
    /**
     * Unit tests the <tt>DigitTrieST</tt> data type.
     */
    public static void main(String[] args) {

        // build symbol table from standard input
        DigitTrieST<Integer> st = new DigitTrieST<Integer>();
